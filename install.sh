...
ADMIN_WHATSAPP_NUMBER="089502289957"
...
;;
     7)
# Default URL gambar
DEFAULT_URL="https://img100.pixhost.to/images/509/538489055_skyzopedia.jpg"
...
if [ $? -eq 0 ]; then
    ...
    echo "TERJADI KESALAHAN SAAT MEMPERBARUI FILE!! SILAHKAN HUBUNGI 089502289957 UNTUK MEMINTA BANTUAN"
fi
 ;;
    5)
     # Masukkan token GitHub langsung di sini
